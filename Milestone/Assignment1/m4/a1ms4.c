...
int main(void)
{
	...
	struct Contact contact = {{{ 0 }}}; //Initializing structure by 0.
	...
	getName(&contact.name); //Call the function.
	...
	printf("\n---------------\n");
	printf("Name Details\n");
	printf("First name: %s", contact.name.firstName); //take the value from address stored in structure which is stored in contact structure.
